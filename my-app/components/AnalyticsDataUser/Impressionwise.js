...
const Impressionwise = () => {
      ...
      await fetch(url)
        ...
        .then((res) => {
          ...
          for (const val of res) {
            dataset.push(val.AdImpressions);
  ...
  return (
    ...
    >
      <h3 className="text-center w-full">Ad Impressions</h3>
      ...
      <div className="flex flex-col w-full h-1/5">
        ...
        <div className="flex flex-col">
          <div className="flex justify-around my-3">
            <p className="text-lg font-normal w-1/2">Total Impressions</p>
          ...
          <div className="flex justify-around my-3">
            <p className="text-lg font-normal w-1/2">
              Maximum Impression Generating Website
            </p>
            <p className="text-lg font-normal w-1/2">
          ...
          <div className="flex justify-around my-3">
            <p className="text-lg font-normal w-1/2">
              Maximum Impression from a website
            </p>
